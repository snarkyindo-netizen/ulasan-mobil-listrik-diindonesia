...
st.write("Coba ketik ulasan Anda di bawah ini!")
...
if st.button("Kirim Ulasan"):
    if nama_user.strip() == "" or ulasan_user.strip() == "":
        ...
        # Menyimpan diam-diam ke brankas
...
# 4. PINTU RAHASIA (Khusus Untuk Anda)
with st.expander("🔒 Mode Admin"):
    # Anda bisa mengganti angka 12345 di bawah ini dengan PIN rahasia Anda sendiri
    pin_rahasia = st.text_input("Masukkan PIN Admin:", type="password")
    
    if pin_rahasia == "12345":
